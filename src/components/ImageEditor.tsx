...
const TOOL_SEPARATOR_AFTER = 3; // separator after 'flip' (index 3)
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-4">
      ...
      <div className="flex items-center justify-between gap-3 flex-wrap">
        <div className="flex items-center gap-1 bg-bg-primary/60 border border-border rounded-xl p-1 flex-wrap">
          {TOOLS.map((tool, i) => (
            <React.Fragment key={tool.id}>
              {i === TOOL_SEPARATOR_AFTER + 1 && (
